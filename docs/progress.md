...
2. TC-017 언어 선택 입력 반응 확인 구현
3. TC-006 기본 입력 반응 확인 구현
4. 입력 전후 screenshot 비교 기준 정의
5. TC-007 짧은 실행 안정성 확인 구현
6. 사람이 보기 좋은 Markdown 실행 요약 리포트 생성 검토
7. TC-014, TC-015, TC-016으로 최초 실행 유저와 기존 플레이 유저 상태 분리
