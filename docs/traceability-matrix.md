...
| TC-006 | 입력 | Space 시각 반응 | [코드](../tests\local\test_tc_018_006_011_post_language_input.py) | 구현됨 | 최신 PASS 1회, delta=0.0259. 점프 성공 확정 아님 ([진단](live-validation-2026-09-15.md)) |
| TC-007 | 안정성 | 짧은 실행 관찰 | [코드](../tests\local\test_tc_007_short_stability.py) | 구현됨 | 최신 PASS 1회, 7개 샘플 프로세스·캡처 유지 ([진단](live-validation-2026-09-15.md)) |
...
| TC-010 | 진입 | 플레이 화면 후보 전환 | [코드](../tests\local\test_tc_010_gameplay_entry.py) | 구현됨 | 크기 변경·이벤트 보존 수정 후 PASS 1회. 3회 반복 미완료 ([진단](live-validation-2026-09-15.md)) |
| TC-011 | 입력 | 방향키 시각 반응 | [코드](../tests\local\test_tc_018_006_011_post_language_input.py) | 구현됨 | PASS 1회, delta=0.3485. 양방향 개별 이동 확정 아님 ([진단](live-validation-2026-09-15.md)) |
| TC-012 | 안정성 | 연속 화면 변화 관찰 | [코드](../tests\local\test_tc_012_freeze_detection.py) | 구현됨 | 최신 PASS 1회, 4개 비교 모두 변화. 내부 프리즈 부재 보장 아님 ([진단](live-validation-2026-09-15.md)) |
